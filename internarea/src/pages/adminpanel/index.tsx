...
const index = () => {
  const stats = [
    { label: 'Total Applications', value: '16', change: '+12%', changeType: 'positive' },
    { label: 'Active Jobs', value: '7', change: '+3%', changeType: 'positive' },
    { label: 'Active Internships', value: '9', change: '+24%', changeType: 'positive' },
